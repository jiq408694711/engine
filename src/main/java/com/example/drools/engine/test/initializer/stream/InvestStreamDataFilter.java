package com.example.drools.engine.test.initializer.stream;

/**
 * Created by jiyiqin on 2018/5/20.
 */

import com.example.drools.engine.engine.initializer.stream.AbstractStreamFilter;
import com.example.drools.engine.test.model.InvestMessage;
import com.example.drools.engine.test.repository.UserInvestMessageRepository;
